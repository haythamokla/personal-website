...
const en = {
	...
	archive: {
		title: 'Archive',
		description: 'Extended photography archive and older gallery work by Haytham Okla.',
		eyebrow: 'Archive',
		heading: 'The extended gallery lives here.',
		text: 'Older albums and extended galleries are available through the legacy portfolio.',
		cta: 'Open Legacy Portfolio',
	},
	contact: {
		title: 'Contact',
...
const nl = {
	...
	archive: {
		title: 'Archief',
		description: 'Uitgebreid fotografiearchief en ouder galerijwerk van Haytham Okla.',
		eyebrow: 'Archief',
		heading: 'De uitgebreide galerij staat hier.',
		text: 'Oudere albums en uitgebreide galerijen zijn beschikbaar via het legacy portfolio.',
		cta: 'Open Legacy Portfolio',
	},
	contact: {
		title: 'Contact',
...
const ar = {
	...
	archive: {
		title: 'الأرشيف',
		description: 'أرشيف تصوير موسع ومعارض قديمة لهيثم عقلة.',
		eyebrow: 'الأرشيف',
		heading: 'المعرض الموسع موجود هنا.',
		text: 'الألبومات القديمة والمعارض الموسعة متاحة عبر البورتفوليو القديم.',
		cta: 'افتح البورتفوليو القديم',
	},
	contact: {
		title: 'تواصل',
...
const tr = {
	...
	archive: {
		title: 'Arşiv',
		description: 'Haytham Okla’nın genişletilmiş fotoğraf arşivi ve eski galeri çalışmaları.',
		eyebrow: 'Arşiv',
		heading: 'Genişletilmiş galeri burada.',
		text: 'Eski albümler ve genişletilmiş galeriler legacy portfolyo üzerinden görülebilir.',
		cta: 'Legacy Portfolyoyu Aç',
	},
	contact: {
		title: 'İletişim',
